...
State lives under `.e2e-engineering/`. Multi-Task layout (default): `queue.json` at root, each Task body under `tasks/<id>/` — `prd.json`, `progress.txt`, `codebase-map.md` (brownfield), `research.md`, `test-cases/*.md`, `qa-signoff.md`, `manifests/<story-id>/` (evidence sidecars). Single-Task legacy keeps files directly under `.e2e-engineering/`. Schemas: [queue.json](../../../skills/e2e-engineering/schemas/queue.json.md), [prd.json](../../../skills/e2e-engineering/schemas/prd.json.md), [progress.txt](../../../skills/e2e-engineering/schemas/progress.txt.md), [qa-signoff](../../../skills/e2e-engineering/schemas/qa-signoff.md), [codebase-map](../../../skills/e2e-engineering/schemas/codebase-map.md), [slice-result](../../../skills/e2e-engineering/schemas/slice-result.json.md), [review-result](../../../skills/e2e-engineering/schemas/review-result.json.md), [verification-result](../../../skills/e2e-engineering/schemas/verification-result.json.md).
