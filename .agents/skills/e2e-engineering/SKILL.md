...
5. [verification](../../../skills/e2e-engineering/impl/verification.md) — **HARD GATE 5 (ADR 0024, ADR 0025):** full automated suite (unit + API) run + AC-checklist-vs-code. NO live-UI exercise. Failures recorded in `qa-signoff.md ## Gate 5 Failures` → Task proceeds to `pending-qa`; human routes each to a repair Task at QA sign-off. Does NOT mark `blocked` on test failure (ADR 0025).
