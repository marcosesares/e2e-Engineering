...
> **SUPERSEDED by ADR 0024 (Fork Y).** E2E is no longer the impl-loop exit. UI is not automated — verified manually in human-QA; only unit + API/integration are automated (gate 2). Gate 4 retired. Entry below is historical.
