# ship-it — Build Plan (handoff for fresh session)
...
3. auto-memory `project_ship_it.md` (decisions + provenance + schemas)

## Goal
Build the ship-it skill: master orchestrator + sub-skills composing best-of 7 prototypes. Idea→e2e. Greenfield + brownfield + adopt.
