...
Produced by `map-codebase` on brownfield tasks only. SCOPED to *this* change — not a global reverse-engineering artifact. Sprint-lifetime, may rot (like research.md). NOT C4/ERD/NxN matrices. Lives at task root (e.g. `.ship-it/codebase-map.md`).
