...
Converts grill-me notes (+ research / prototype / codebase-map findings) into the formal PRD and writes `.ship-it/prd.json`. Owns its OWN interview step — fill gaps directly, no double-interview with grill-me. Provenance: mattpocock to-prd. Schema: [prd.json](../schemas/prd.json.md).
