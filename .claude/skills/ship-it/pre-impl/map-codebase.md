...
Fires only on brownfield (task targets existing code). Skipped for greenfield. Produces `.ship-it/codebase-map.md` SCOPED to *this* change — NOT a global C4/ERD/NxN matrix. Sprint-lifetime, may rot. See ADR 0009. Schema: [codebase-map](../schemas/codebase-map.md).
