...
Fires only when the task leans on external APIs / unfamiliar libs / unknown protocols. grill-me gates it. Skipped cleanly when not needed. Produces `.ship-it/research.md`: sprint-lifetime cache, MAY ROT — flag it stale-able.
