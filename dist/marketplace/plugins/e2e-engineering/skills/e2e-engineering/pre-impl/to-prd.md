...
Converts grill-me notes (+ research / prototype / codebase-map findings) into the formal PRD and writes `.e2e-engineering/prd.json`. Owns its OWN interview step — fill gaps directly, no double-interview with grill-me. Provenance: mattpocock to-prd. Schema: [prd.json](../schemas/prd.json.md).

## What to do
1. Synthesize grill-me notes + any research.md / prototype conclusions / codebase-map (sections 1-4) into a coherent product spec.
2. Interview ONLY to close remaining gaps (don't re-ask what grill-me settled).
...
## Red flags (stop)
- Re-interviewing on questions grill-me already resolved.
